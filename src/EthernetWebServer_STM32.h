...
#define ETHERNET_WEBSERVER_STM32_VERSION            "EthernetWebServer_STM32 v1.3.4"

#define ETHERNET_WEBSERVER_STM32_VERSION_MAJOR      1
#define ETHERNET_WEBSERVER_STM32_VERSION_MINOR      3
#define ETHERNET_WEBSERVER_STM32_VERSION_PATCH      4

#define ETHERNET_WEBSERVER_STM32_VERSION_INT        1003004
